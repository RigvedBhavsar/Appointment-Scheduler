...
namespace AppointmentScheduling.Services
{
    public class AppointmentService : IAppointmentService
    {
        ...
        {
            //Using LINQ and Query Syntax projection (select * from ASPNETUsers)
            //We going to databse user tables and iterating through each record and retriving only id , nameS
